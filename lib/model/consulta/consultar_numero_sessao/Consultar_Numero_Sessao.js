...
exports.ModelConsultarNumeroSessao = void 0;
var ModelConsultarNumeroSessao = /** @class */ (function () {
    function ModelConsultarNumeroSessao(numeroSessao, EEEEE, mensagem, cod, mensagemSEFAZ) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        console.error('ModelConsultarNumeroSessao.fromArray<Exception> ', error);
                    }
                    return [2 /*return*/];
                });
            });
    ...
    return ModelConsultarNumeroSessao;
}());
exports.ModelConsultarNumeroSessao = ModelConsultarNumeroSessao;
