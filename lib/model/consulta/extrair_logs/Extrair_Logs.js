...
exports.ModelExtrairLogs = void 0;
var ModelExtrairLogs = /** @class */ (function () {
    function ModelExtrairLogs(numeroSessao, EEEEE, mensagem, cod, mensagemSEFAZ, arquivoLog) {
        if (numeroSessao === void 0) { numeroSessao = ''; }
        if (EEEEE === void 0) { EEEEE = ''; }
        if (mensagem === void 0) { mensagem = ''; }
        if (cod === void 0) { cod = ''; }
        if (mensagemSEFAZ === void 0) { mensagemSEFAZ = ''; }
        if (arquivoLog === void 0) { arquivoLog = ''; }
    ...
    return ModelExtrairLogs;
}());
exports.ModelExtrairLogs = ModelExtrairLogs;
