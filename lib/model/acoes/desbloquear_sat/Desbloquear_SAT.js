...
exports.ModelDesbloquearSAT = void 0;
var ModelDesbloquearSAT = /** @class */ (function () {
    function ModelDesbloquearSAT(numeroSessao, EEEEE, mensagem, cod, mensagemSEFAZ) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        console.error('ModelDesbloquearSAT.fromArray<Exception> ', error);
                    }
                    return [2 /*return*/];
                });
            });
    ...
    return ModelDesbloquearSAT;
}());
exports.ModelDesbloquearSAT = ModelDesbloquearSAT;
