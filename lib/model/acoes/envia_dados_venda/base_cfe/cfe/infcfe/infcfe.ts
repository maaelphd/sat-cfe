...
export class InfCFe implements IInfCFe { 
  ...
  constructor(versaoDadosEnt: string = '', ide: Ide = new Ide(), emit: Emit = new Emit(), dest: Dest = new Dest(), entrega: Entrega = null,
              det: [Det] = [new Det()], total: Total = new Total(), pgto: Pgto = new Pgto(), infAdic: InfAdic = new InfAdic()) {
    this.$ = {
