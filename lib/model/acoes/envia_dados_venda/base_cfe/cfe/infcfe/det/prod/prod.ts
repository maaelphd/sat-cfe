...
export class Prod implements IProd { 
  ...
  constructor(cProd: string = '', cEAN: string = '', xProd: string = '', NCM: string = '', CEST: number = 0, CFOP: number = 0, uCom: string = '',
              qCom: number = 0, vUnCom: number = 0, indRegra: string = '', vDesc: string = '') {
    this.cProd = cProd;
    this.cEAN = cEAN;
    this.xProd = xProd;
    this.NCM = NCM;
