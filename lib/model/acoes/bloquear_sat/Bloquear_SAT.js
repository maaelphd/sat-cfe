...
exports.ModelBloquearSAT = void 0;
var ModelBloquearSAT = /** @class */ (function () {
    function ModelBloquearSAT(numeroSessao, EEEEE, mensagem, cod, mensagemSEFAZ) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        console.error('ModelBloquearSAT.fromArray<Exception> ', error);
                    }
                    return [2 /*return*/];
                });
            });
    ...
    return ModelBloquearSAT;
}());
exports.ModelBloquearSAT = ModelBloquearSAT;
